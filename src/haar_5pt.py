...
class Haar5ptDetector:
    def __init__(
        ...
        # (commonly used set; works well in practice)
    ...
    def detect(
        ...
        # Build centered bbox from keypoints
        # (solves your “aside” offset)
        box = _bbox_from_5pt(
            kps,
            pad_x=0.55,
            pad_y_top=0.85,
...
def main():
    ...
    print(
        "Haar + 5pt (FaceMesh) test. Press q to quit."
    )
